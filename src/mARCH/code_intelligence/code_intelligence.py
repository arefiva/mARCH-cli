...
class CodeIntelligence:
    ...
    def find_symbol_definition(
        ...
        if language:
            ...
            if client:
                ...
                return cast(Location | None, result)
    ...
    def search_code(
        ...
        return cast(list[SearchMatch], result)
    ...
    def search_symbol(
        ...
        result = self.searcher.search_symbol(symbol, directory=directory)
        return cast(list[SearchMatch], result)
    ...
    def find_functions(
        ...
        result = self.searcher.find_functions(
    ...
    def find_classes(
        ...
        result = self.searcher.find_classes(
            directory=directory, language=language
        )
        return cast(list[SearchMatch], result)
    ...
    def find_todos(self, directory: str = ".") -> list[SearchMatch]:
        ...
        result = self.searcher.find_todos(directory=directory)
        return cast(list[SearchMatch], result)
    ...
    def get_code_outline(
        ...
        """
        result = self.parser.get_outline(file_path)
    ...
    def highlight_code(
        ...
        if line_numbers:
            ...
            result = self.highlighter.get_inline_highlight(code, language)
    ...
    def get_completions(
        ...
        if language:
            client = self.lsp_manager.get_client(language)
            if client:
                result = client.complete(file_path, line, character)
                return cast(list[CompletionItem], result)
