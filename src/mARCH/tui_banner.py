...
class Banner:
    ...
    # mARCH CLI banner (simplified, not overly complex)
    COPILOT_BANNER = r"""
    ...
    def show_welcome_screen(
        ...
        # Welcome info panel
        info_text = f"""[bold]Welcome to GitHub mARCH CLI![/bold]
...
Type any question or code snippet to chat with mARCH!"""
...
_banner_instance: Banner | None = None
_progress_bar_instance: ProgressBar | None = None


def get_banner() -> Banner:
    """Get or create banner instance."""
    global _banner_instance
    if _banner_instance is None:
        _banner_instance = Banner()
    return _banner_instance
