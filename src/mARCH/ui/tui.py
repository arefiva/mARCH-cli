"""
Unified Terminal User Interface (TUI) for mARCH CLI.
...
class mARCHTUI:
    """Main TUI interface for mARCH CLI."""

    def __init__(self, console: Console | None = None):
        """
        Initialize mARCH TUI.
...
_march_tui_instance: mARCHTUI | None = None


def get_march_tui() -> mARCHTUI:
    """Get or create singleton mARCHTUI instance."""
    global _march_tui_instance
    if _march_tui_instance is None:
        _march_tui_instance = mARCHTUI()
    return _march_tui_instance
