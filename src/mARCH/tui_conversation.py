...
_conversation_renderer_instance: ConversationRenderer | None = None
_input_prompt_instance: InputPrompt | None = None
...
def get_conversation_renderer() -> ConversationRenderer:
    ...
    global _conversation_renderer_instance
    if _conversation_renderer_instance is None:
        _conversation_renderer_instance = ConversationRenderer()
    return _conversation_renderer_instance


def get_input_prompt() -> InputPrompt:
    """Get or create input prompt instance."""
    global _input_prompt_instance
    if _input_prompt_instance is None:
        _input_prompt_instance = InputPrompt()
    return _input_prompt_instance
