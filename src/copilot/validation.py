...
class HealthChecker:
    ...
    def check_platform_support(self) -> HealthCheckResult:
        ...
        from platform_utils import OSType, get_platform_info
...
class IntegrationValidator:
    ...
    def validate_github_integration() -> bool:
        ...
        try:
            from copilot import github_integration
    ...
    def validate_code_intelligence() -> bool:
        ...
        try:
            from copilot import code_intelligence
    ...
    def validate_tui_module() -> bool:
        ...
        try:
            from copilot import tui
            return hasattr(tui, "CopilotTUI")
        except Exception:
            return False
    ...
    def validate_agent_module() -> bool:
        ...
        try:
            from copilot import agent_state
