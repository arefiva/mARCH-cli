...
def get_conversation_client() -> ConversationClient:
    ...
    if not hasattr(get_conversation_client, "_instance"):
        get_conversation_client._instance = ConversationClient()
    return get_conversation_client._instance


def get_code_analysis_client() -> CodeAnalysisClient:
    """Get or create singleton CodeAnalysisClient."""
    if not hasattr(get_code_analysis_client, "_instance"):
        get_code_analysis_client._instance = CodeAnalysisClient()
    return get_code_analysis_client._instance
