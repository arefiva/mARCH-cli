...
_tui_layout_instance: TUILayout | None = None
_window_manager_instance: WindowManager | None = None
_status_bar_instance: StatusBar | None = None


def get_tui_layout() -> TUILayout:
    """Get or create TUI layout instance."""
    global _tui_layout_instance
    if _tui_layout_instance is None:
        _tui_layout_instance = TUILayout()
    return _tui_layout_instance
...
def get_status_bar() -> StatusBar:
    ...
    if _status_bar_instance is None:
        _status_bar_instance = StatusBar()
